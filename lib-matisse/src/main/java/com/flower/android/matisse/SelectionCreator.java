...
import com.flower.android.matisse.engine.ImageEngine;
import com.flower.android.matisse.filter.Filter;
import com.flower.android.matisse.internal.entity.CaptureStrategy;
import com.flower.android.matisse.internal.entity.SelectionSpec;
import com.flower.android.matisse.listener.OnCheckedListener;
import com.flower.android.matisse.listener.OnSelectedListener;
import com.flower.android.matisse.ui.MatisseActivity;
import com.flower.android.matisse.ui.MatisseCameraActivity;
...
public final class SelectionCreator {
     ...
     * 1. com.flower.android.matisse.R.style.Matisse_Zhihu;
     * 2. com.flower.android.matisse.R.style.Matisse_Dracula
     * you can define a custom theme derived from the above ones or other themes.
     *
     * @param themeId theme resource id. Default value is com.flower.android.matisse.R.style.Matisse_Zhihu.
     * @return {@link SelectionCreator} for fluent API.
     */
     ...
     * 1. {@link com.flower.android.matisse.engine.impl.GlideEngine}
     * 2. {@link com.flower.android.matisse.engine.impl.PicassoEngine}
     ...
     */
    public void fromAlbum(int requestCode) {
    ...
    public void fromCamera(int requestCode) {
        ...
        Intent intent = new Intent(activity, MatisseCameraActivity.class);
    ...
    public void fromCameraCrop(int requestCode) {
        Activity activity = mMatisse.getActivity();
        if (activity == null) {
            return;
        }
